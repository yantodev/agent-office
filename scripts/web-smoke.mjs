...
try {
  ...
  const routerModels = await fetch(`${base}/v1/integrations/9router/models`, { headers: { authorization: 'Bearer smoke-token' } })
  assert.equal(routerModels.status, 200)
  assert.deepEqual((await routerModels.json()).models, [])
